...
[![GoDoc Documentation](http://godoc.org/github.com/kyawmyintthein/hystrix-go/hystrix?status.png)](https://godoc.org/github.com/kyawmyintthein/hystrix-go/hystrix)
...
For API documentation, refer to [GoDoc](https://godoc.org/github.com/kyawmyintthein/hystrix-go/hystrix)

How to use
----------

```go
import "github.com/kyawmyintthein/hystrix-go/hystrix"
```
...
- ```cd /go/src/github.com/kyawmyintthein/hystrix-go```
- ```go test ./...```
